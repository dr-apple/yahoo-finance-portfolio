...
Version `0.3.5` is compatible with Home Assistant `2026.8` and tested against
`2026.8.1`.
...
1. Add one or more `notify.*` targets in **Push-Ziele**. Pick a suggestion or type the target manually:
